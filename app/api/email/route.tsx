...
export async function POST(req: Request): Promise<NextResponse> {
    const { sender, content }: { sender: string; content: string } =
        await req.json();

    const getHtml = (sender: string, content: string) => {
    ...
    try {
        await transporter.sendMail(
            mailOptions(sender, content, getHtml(sender, content))
        );
